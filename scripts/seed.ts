...
const products = [
  ...
  // 🆕 Extra products
  {
    ...
    description: '15W fast wireless charger compatible with all Qi devices. Slim, non-slip surface.',
    price: 29.99,
    stock: 60,
    categoryId: 'electronics',
    images: ['https://images.unsplash.com/photo-1591370874773-6702e8f12fd8?w=800&q=80'],
    sellerId: 'seed',
    status: 'active',
    rating: 4.5,
    reviewCount: 231,
  ...
  {
    title: 'Silk Scrunchie Set (5 pcs)',
    description: 'Pure mulberry silk scrunchies in 5 pastel colors. Gentle on hair, no creases.',
    price: 16.00,
    stock: 90,
    categoryId: 'fashion',
  ...
  },
  {
    ...
    description: 'Everything you need for smooth cold brew at home: mason jar, filter, recipe card.',
    price: 34.00,
    stock: 40,
    categoryId: 'food',
  ...
  },
  {
    ...
    description: 'Set of 4 handmade epoxy resin coasters with gold flakes. Each piece is unique.',
    price: 38.00,
    stock: 20,
    categoryId: 'handmade',
    images: ['https://images.unsplash.com/photo-1615486511484-92e172cc4fe0?w=800&q=80'],
    sellerId: 'seed',
    status: 'active',
    rating: 4.9,
    reviewCount: 112,
  },
  {
    ...
    description: '2–24kg adjustable dumbbell pair with quick-lock mechanism. Replaces 8 pairs.',
    price: 219.00,
    stock: 12,
    categoryId: 'sports',
  ...
  },
  {
    ...
    description: 'Stonewashed 100% linen duvet cover + 2 pillowcases. Breathable, gets softer with wash.',
    price: 145.00,
    stock: 18,
    categoryId: 'home',
