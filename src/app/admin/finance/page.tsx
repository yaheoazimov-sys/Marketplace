...
export default function AdminFinancePage() {
  ...
  const sc = (s: string) => ({ paid: '#15803d', delivered: '#14532d', confirmed: '#7c3aed', pending: '#92400e', cancelled: '#991b1b', refunded: '#374151' }[s] || '#374151');
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.kpiGrid}>
        ...
        <div className={styles.kpi}><p className={styles.kpiLabel}>Platform Commission (5%)</p><p className={styles.kpiVal} style={{ color: '#7c3aed' }}>${commission.toLocaleString('en', { minimumFractionDigits: 2 })}</p><p className={styles.kpiSub}>Estimated earnings</p></div>
            ...
            <tbody>
              {orders.map(o => (
                <tr key={o.id}>
                  ...
                  <td style={{ color: '#7c3aed', fontWeight: 600 }}>${(o.totalAmount * 0.05).toFixed(2)}</td>
